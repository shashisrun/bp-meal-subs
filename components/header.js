...
export default function Header() {
    ...
    return (
        <header className="px-2 py-3 w-full sticky top-0 bg-base-200 flex-none h-18 z-50 border-b-2 mb-2 border-primary">
            <div className="flex flex-row">
                ...
                <div className="w-2/12">
                    <Link href='notifications'>
                        <div className='py-2 px-2 text-base-100 bg-primary rounded-full'>
                            <IoNotifications size={28} className="mx-auto" />
                        </div>
                    </Link>
                </div>
                {/* <div className="w-2/12">
